...
public class PacienteControllerMockMvcIT extends AbstractIntegration {
    ...
    @Test
    @DisplayName("Actualizar paciente con PUT y verificar que se ha actualizado correctamente con GET")
    void updatePaciente_PacienteIsUpdatedObtainsWithGet() throws Exception {
        crearMedico(medico);
        crearPaciente(paciente);

        paciente.setCita("Dermatologia");
    ...
    @Test
    @DisplayName("Borrar paciente con DELETE y verificar que se ha borrado correctamente con GET")
    void deletePaciente_PacienteIsDeletedObtainsWithGet() throws Exception {
        crearMedico(medico);
        crearPaciente(paciente);
